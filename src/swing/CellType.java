...
public class CellType extends javax.swing.JPanel {

    public CellType(TrainType type) {
        initComponents();
        status.setType(type);
    }
    ...
    private void initComponents() {
        ...
        status = new swing.TableType();

        setBackground(new java.awt.Color(255, 255, 255));

        status.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        status.setText("tableType2");
    ...
    private swing.TableType status;
